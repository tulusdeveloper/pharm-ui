                    ...
                    <div className="card">
                        ...
                        <div className="body">
                            <form onSubmit={this.formSubmit}>
                                ...
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="address" name="address" className="form-control" placeholder="Enter Company Address"/>
                                    </div>
                                </div>
                                ...
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="contact_no" name="contact_no" className="form-control" placeholder="Enter Contact No"/>
                                    </div>
                                </div>
                                ...
                                <label htmlFor="email_address">Company Description</label>
                                <div className="form-group">
                                    <div className="form-line">
